module github.com/asosick/iridium_layout_manager
...
require (
	...
	github.com/iridiumgo/iridium v0.0.0-20260527211159-252c000af99d // indirect
	github.com/iridiumgo/iridium-icons v1.0.7 // indirect
